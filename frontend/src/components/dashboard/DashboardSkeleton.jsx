      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="h-9 bg-[#171717] border border-[#262626] rounded-lg w-32 animate-pulse"></div>
          </div>
        </motion.div>
        ...
        >
          {[...Array(6)].map((_, i) => (
            <motion.div 
              key={i} 
              variants={itemVariants}
              className="bg-[#0A0A0A] border border-[#171717] rounded-xl p-5"
            >
        ...
        <motion.div 
          variants={itemVariants}
          className="bg-[#0A0A0A] border border-[#171717] rounded-xl p-6 mb-8"
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-4">
              <div className="h-6 bg-[#171717] rounded w-32 animate-pulse"></div>
              <div className="flex items-center space-x-2">
                <div className="h-8 bg-[#171717] border border-[#262626] rounded w-20 animate-pulse"></div>
                <div className="h-8 bg-[#171717] border border-[#262626] rounded w-16 animate-pulse"></div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  {[...Array(3)].map((_, i) => (
                    <motion.div 
                      key={i} 
                      variants={itemVariants}
                      className="border border-[#171717] rounded-xl p-5"
                    >
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-4">
