...
function NavBar() {
  ...
  return (
    <motion.header
      ...
      className="bg-[#000000] shadow-lg border-b border-[#171717]"
    >
      <div className="max-w-6xl mx-auto px-3 sm:px-5 lg:px-7">
        <div className="flex justify-between items-center h-14">
          ...
          <div className="flex items-center space-x-4">
            <motion.span 
              className="text-[#A3A3A3] border border-[#262626] px-2.5 py-1 rounded-full bg-[#171717]/50 flex items-center space-x-1.5"
